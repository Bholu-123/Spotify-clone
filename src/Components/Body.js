  ...
  return (
    <div className="body">
      ...
      <div className="body-info">
        <img
          id="discover-profileImage"
          src={discoverPlaylist?.images[0].url}
          alt=""
        />
        <div className="body-infoText">
          ...
          <p>
            <a href="https://open.spotify.com/user/spotify">
              {discoverPlaylist?.owner.display_name}
            </a>
      ...
      <div className="body-songs">
        ...
        <ul className="body-songsHeader">
          <li className="body-songsNumber">
            <p>#</p>
          </li>
          <li className="body-songsTitle">
            <p>TITLE</p>
          </li>
          <li className="body-songsAlbum">
            <p>ALBUM</p>
          </li>
          <li className="body-songsRelease">
            <p>RELEASE</p>
          </li>
